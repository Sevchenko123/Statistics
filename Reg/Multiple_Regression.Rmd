...
summary(evals$score)
ggplot(evals,aes(x=score))+geom_histogram(aes(y=..density..),color='black',fill='white')+geom_density(alpha=0.2,fill='red')+theme_bw()
```
...
ggplot(evals,aes(x=gender,y=age))+geom_boxplot(color='black',fill='red')+theme_bw()
```
...
ggplot(data = evals, aes(x = bty_avg, y = score)) +
  geom_point(color='red',pch=19)+theme_bw()
```
...
# type your code for the Exercise here, and Knit
ggplot(data = evals, aes(x = bty_avg, y = score)) +
  geom_jitter(color='red',pch=19)+theme_bw()
```
