...
qplot(at_bats,runs,data=mlb11,color=I('red'),size=I(3))+theme_bw()+labs(x='Bats',y='Runs')
```
...
# Based on the model it predicts runs as (-2789.2429 + 0.6305 * at_bats) so it predicts 728.32 so residual = 15.32
```
...
qplot(hits,runs,data=mlb11,color=I('red'),size=I(3))+theme_bw()+labs(x='Hits',y='Runs')
```
...
```{r}
qplot(new_obs,runs,data=mlb11,color=I('red'),size=I(3))+theme_bw()+labs(x='New Obs',y='Runs')
```
