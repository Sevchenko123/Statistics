...
inference(y = response, data = cn12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
inference(y = response, data = spn12, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
inference(y = response, data = spn05, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
