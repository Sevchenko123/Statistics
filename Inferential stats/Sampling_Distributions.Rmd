...
ggplot(data = ames, aes(x = area)) +
  geom_histogram(color = 'white', fill = 'brown', binwidth = 250)+theme_bw()+labs(y="Number of Homes",x="Area")
```
...
ggplot(data = samp1, aes(x = area)) +
  geom_histogram(color = 'white', fill = 'black', binwidth = 250)+theme_bw()+labs(y="Number of Homes",x="Area")
```
...
ggplot(data = sample_means50, aes(x = x_bar)) +
  geom_histogram(color = 'black', fill= 'red',binwidth = 20)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
...
sample_means_small <- ames %>%
                    rep_sample_n(size = 10, reps = 25, replace = TRUE) #%>% summarise(x_bar = mean(area))
```
...
ggplot(data = sample_means_small, aes(x = x_bar)) + geom_histogram(color = 'black', fill= 'red',binwidth = 20)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
...
```{r hist}
ggplot(data = sample_means50, aes(x = x_bar)) + geom_histogram(color = 'black', fill= 'red',binwidth = 20)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
  ...
  server <- function(input, output) {
    ...
    output$sampling_plot <- renderPlot({
      ...
      ggplot(sampling_dist(), aes(x = x_bar)) +
        geom_histogram(color='black',fill='red') + theme_bw()+
        xlim(x_min, x_max) +
...
price_sample <- ames %>% rep_sample_n(size = 50, reps = 15000, replace = TRUE) %>% summarise(x_bar = mean(price))
mean(price_sample$x_bar)
```
...
```{r price-sampling}
# type your code for this Exercise here, and Run Document
sample_means50 <- ames %>% rep_sample_n(size=50,reps=5000,replace=T)%>% summarise(x_bar = mean(price))
ggplot(data = sample_means50, aes(x = x_bar)) + geom_histogram(color = 'black', fill= 'red',binwidth = 1000)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
...
# type your code for this Exercise here, and Run Document
sample_means150 <- ames %>% rep_sample_n(size=150,reps=5000,replace=T)%>% summarise(x_bar = mean(price))
ggplot(data = sample_means150, aes(x = x_bar)) + geom_histogram(color = 'black', fill= 'red',binwidth = 1000)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
...
# type your code for this Exercise here, and Run Document
price_sample_small <- ames %>% sample_n(size = 15) %>% summarise(x_bar = mean(price))
```
...
# type your code for this Exercise here, and Run Document
sample_means15 <- ames %>% rep_sample_n(size=15,reps=2000,replace=T) %>% summarise(x_bar = mean(price))
ggplot(data = sample_means15, aes(x = x_bar)) + geom_histogram(color = 'black', fill= 'red',binwidth = 1000)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
...
# type your code for this Exercise here, and Run Document
sample_means150 <- ames %>% rep_sample_n(size=150,reps=2000,replace=T) %>% summarise(x_bar = mean(price))
ggplot(data = sample_means150, aes(x = x_bar)) + geom_histogram(color = 'black', fill= 'red',binwidth = 1000)+theme_bw()+labs(x="Sample Mean",title = "Sampling Distribution")
```
